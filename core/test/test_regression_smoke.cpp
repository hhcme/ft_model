...
int main() {
    const std::vector<SmokeCase> smoke_cases = {
        // === DXF: original fixtures ===
        {.path = "test_data/minimal.dxf",
         .min_entities = 4, .max_entities = 4,
         .min_batches = 2, .max_batches = 2,
         .min_vertices = 100, .max_vertices = 110,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/basic_primitives.dxf",
         .min_entities = 30, .max_entities = 30,
         .min_batches = 3, .max_batches = 5,
         .min_vertices = 800, .max_vertices = 900,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/lwpolyline.dxf",
         .min_entities = 6, .max_entities = 6,
         .min_batches = 1, .max_batches = 1,
         .min_vertices = 250, .max_vertices = 280,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/insert_blocks.dxf",
         .min_entities = 33, .max_entities = 33,
         .min_batches = 2, .max_batches = 2,
         .min_vertices = 1500, .max_vertices = 1600,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/text_entities.dxf",
         ...
         .expect_bounds_empty = false},
        {.path = "test_data/edge_cases.dxf",
         .min_entities = 12, .max_entities = 14,
         .min_batches = 3, .max_batches = 6,
         .min_vertices = 300, .max_vertices = 320,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        // === DXF: new entity type coverage ===
        {.path = "test_data/advanced_primitives.dxf",
         .min_entities = 17, .max_entities = 17,
         .min_batches = 2, .max_batches = 4,
         .min_vertices = 630, .max_vertices = 650,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/hatch_dimensions.dxf",
         .min_entities = 8, .max_entities = 10,
         .min_batches = 3, .max_batches = 5,
         .min_vertices = 9900, .max_vertices = 10000,
         .min_texts = 0, .max_texts = 1,
         .expect_bounds_empty = false},
        {.path = "test_data/insert_advanced.dxf",
         .min_entities = 12, .max_entities = 15,
         .min_batches = 1, .max_batches = 3,
         .min_vertices = 1200, .max_vertices = 1250,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/text_mtext_rich.dxf",
         .min_entities = 9, .max_entities = 9,
         .min_batches = 1, .max_batches = 1,
         .min_vertices = 15, .max_vertices = 25,
         .min_texts = 8, .max_texts = 9,
         .expect_bounds_empty = false},
        {.path = "test_data/edge_cases_v2.dxf",
         .min_entities = 12, .max_entities = 12,
         .min_batches = 4, .max_batches = 6,
         .min_vertices = 640, .max_vertices = 650,
         .min_texts = 0, .max_texts = 0,
         .expect_bounds_empty = false},
        {.path = "test_data/stress_50k.dxf",
         .min_entities = 49000,
         .min_batches = 5,
         .min_vertices = 200000,
         .expect_bounds_empty = false,
